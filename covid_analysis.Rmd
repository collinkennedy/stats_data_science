...
#merge us states and this
california_vaccination_df = california_data %>% left_join(california_vaccinations, by= "date") %>% 
  select(date, state.x,fips,cases,total_deaths,daily_deaths,people_fully_vaccinated_per_hundred,total_vaccinations,total_distributed,people_vaccinated,share_doses_used)
